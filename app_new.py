...
# Download deployment zip file endpoint
@app.route('/download-deploy-files')
def download_deploy_files():
    """Download the deployment zip file"""
    try:
        return send_file('ready_tech_deploy.zip', 
                         as_attachment=True, 
                         download_name='ready_tech_deploy.zip')
    except Exception as e:
